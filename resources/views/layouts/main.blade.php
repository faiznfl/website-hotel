...
<body class="bg-gray-50 text-gray-900 antialiased font-sans flex flex-col min-h-screen">
    ...
    {{-- 1. Navbar --}}
    {{-- Pastikan di components/navbar.blade.php class utamanya pakai 'sticky top-0 z-50' agar menempel tapi tidak
    menimpa konten --}}
    @include('components.navbar')

    {{-- 2. Konten Utama --}}
    {{-- HAPUS pt-[80px] AGAR TIDAK ADA GAP --}}
