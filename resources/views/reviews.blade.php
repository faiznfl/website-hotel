...
@section('content')
    ...
    {{-- 1. HEADER HALAMAN --}}
    <div class="bg-gray-900 py-16 text-center text-white">
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            <a href="{{ route('home') }}"
                class="inline-flex items-center gap-2 mt-8 text-yellow-400 hover:text-yellow-300 font-semibold transition">
        ...
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            @if($reviews->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    @foreach($reviews as $testi)
                        <div
                            class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 relative hover:-translate-y-1 hover:shadow-md transition duration-300">

                            {{-- Ikon Kutipan --}}
                            <div class="absolute top-4 right-6 text-gray-100 text-6xl font-serif">”</div>
                            ...
                            {{-- Isi Review --}}
                            <p class="text-gray-600 italic mb-6 leading-relaxed text-sm relative z-10 min-h-[60px]">
                                "{{ $testi->content }}"
                            </p>
            ...
            @else
                ...
                <div class="text-center py-20">
                    ...
                    <p class="text-gray-500 mt-2">Jadilah tamu pertama yang memberikan ulasan!</p>
                    <a href="{{ route('home') }}#testimoni"
                        class="mt-6 inline-block bg-yellow-400 text-white px-6 py-2 rounded-lg font-bold hover:bg-yellow-500 transition">
                        Tulis Review
                    </a>
                </div>
            @endif
