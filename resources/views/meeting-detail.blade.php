...
@section('content')
    ...
    {{-- HEADER IMAGE - TETAP ASLI BAWAAN KAKAK --}}
    <div class="relative h-[50vh] md:h-[60vh] w-full overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 w-full p-6 md:p-12 bg-gradient-to-t from-black/90 to-transparent">
            <div class="max-w-screen-xl mx-auto">
                <h1 class="text-2xl sm:text-3xl md:text-5xl font-extrabold text-white uppercase tracking-wide mb-2 shadow-sm leading-tight">
                    {{ $meeting->judul }}
                </h1>
            </div>
        </div>
                ...
                <div class="lg:col-span-2 space-y-6 md:space-y-8">
                    ...
                    <div class="bg-white rounded-2xl p-5 md:p-8 shadow-sm border border-gray-100">
                        <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-6 border-l-4 border-yellow-500 pl-4">
                            INCLUDED FACILITIES & CAPACITY
                        </h3>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                            {{-- TAMBAHAN KAPASITAS DI SISI KIRI (Simpel & Sederhana) --}}
                            <div class="flex items-center gap-3 p-3 md:p-4 border border-yellow-100 rounded-xl bg-yellow-50/50">
                                <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center text-yellow-600 shadow-sm flex-shrink-0">
                                    <i class="fa-solid fa-users"></i>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-xs text-gray-400 font-bold uppercase tracking-wider"></span>
                                    <span class="text-gray-900 text-sm md:text-base font-extrabold">Max {{ $meeting->kapasitas ?? '100' }} Orang</span>
                                </div>
                            </div>
                            ...
                            @if ($meeting->fasilitas)
                                @foreach (explode(',', $meeting->fasilitas) as $facility)
                                    <div class="flex items-center gap-3 p-3 md:p-4 border border-gray-100 rounded-xl bg-gray-50 hover:bg-yellow-50 transition-colors">
                                        <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center text-yellow-500 shadow-sm flex-shrink-0">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sticky top-20">
                        ...
                        <div class="mb-6">
                            ...
                            {{-- TAMBAHAN SUB-INFO KAPASITAS DI FORM UTAMA --}}
                            <p class="text-xs text-gray-400 font-medium">Kapasitas maksimal ruangan ini: <span class="text-yellow-600 font-bold">{{ $meeting->kapasitas ?? '100' }} Pax</span></p>
                        </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="relative group">
                                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400 group-focus-within:text-yellow-500">
                        ...
                        <div class="relative my-8">
                            ...
                            <div class="relative flex justify-center text-xs uppercase"><span class="bg-white px-2 text-gray-400">Or Quick Inquiry</span></div>
                        </div>
